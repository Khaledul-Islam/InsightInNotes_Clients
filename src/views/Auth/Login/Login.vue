      ...
      <v-card class="auth-card">
        ...
        <v-card-title class="d-flex align-center justify-center py-7">
          <router-link to="/" class="d-flex align-center">
            ...
            <h2 class="text-2xl font-weight-semibold">InsightIn Technology</h2>
          </router-link>
        </v-card-title>

        <!-- title -->
        <v-card-text>
          <p class="text-2xl font-weight-semibold text--primary mb-2 text-center">Note Management</p>
        ...
        <v-card-text>
          <v-form>
            <v-text-field v-model="user.username" outlined label="Email" hide-details class="mb-3"></v-text-field>
  ...
  methods: {
    login() {
      if (
        ...
        (this.user.username == undefined && this.user.password == null) ||
        this.user.password == undefined
      ) {
        this.$root.snackbar.seterrortext('Email and Password Required')
      }
