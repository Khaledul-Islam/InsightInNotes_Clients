<template>
  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        ...
        <v-slide-x-transition>
          <h2 class="app-title text--primary">Note Management</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-link title="Note Category" :to="{ name: 'noteCategory' }" :icon="icons.mdiFileOutline"></nav-menu-link>
      <nav-menu-link title="Notes" :to="{ name: 'notes' }" :icon="icons.mdiFileOutline"></nav-menu-link>
    </v-list>
